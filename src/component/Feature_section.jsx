  ...
  return (
    <section className="bg-green-50 py-5">
      <div className="container mx-auto text-center">
        <h2 className="text-4xl font-bold mb-4">Everything you need to shop smarter</h2>
        <p className="text-2xl mb-8">Simple yet powerful features to make grocery shopping a breeze</p>
        <div className="flex justify-center gap-8">
          {features.map((feature, index) => (
            <div key={index} className="bg-white shadow-md rounded-lg p-6 text-start">
