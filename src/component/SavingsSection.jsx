  ...
  return (
    <section className="bg-green-50 py-12">
      <div className="container mx-auto text-center]">
        ...
        <div className="bg-white shadow-lg rounded-lg px-8 py-6 inline-block">
          <div className="flex flex-col md:flex-row items-center gap-32 mb-6">
          ...
          <Button btn_text={'Start Saving Today'}  classname="bg-[#047857] hover:bg-green-600 text-white text-sm font-semibold px-11 py-3 rounded-md shadow-md transition-all duration-300 w-[40vw] cursor-pointer"/>
        </div>
      </div>
    </section>
  );
